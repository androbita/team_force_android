...
public class SellingChartPresenter implements SellingChartContract.Presenter {

    private SellingChartContract.View view;
    private SalesAppService salesAppService;
    private UserService userService;
    private CompositeSubscription subscriptions;

    public SellingChartPresenter(SellingChartContract.View view, SalesAppService salesAppService, UserService userService) {
        this.view = view;
    ...
    @Override
    public void getSellingChart(String viewBy) {
        view.showLoading();
        ...
        Subscription subscription = salesAppService.postSellingChart(request, new SalesAppService.ServiceCallback<Response<ChartResponseModel>>() {
            @Override
            public void onSuccess(Response<ChartResponseModel> response) {
                view.hideLoading();

                if (response.isSuccess()) {
                    view.showSellingChart(response.data);
                } else {
